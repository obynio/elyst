...
public class HandlerList extends SQLiteOpenHelper
{
    ...
    private static final String LIST_CREATE = "CREATE TABLE " + CURRENT_TABL + " (" + COLUMN_ID_DB + " TEXT, " + COLUMN_NAME + " TEXT, " + COLUMN_DESCRIPTION + " TEXT, " + COLUMN_REMINDER + " TEXT, " + COLUMN_BACKGROUND + " INTEGER DEFAULT 0);";
    protected static final String LIST_INSERT = "INSERT INTO " + CURRENT_TABL + " VALUES (?, ?, ?, ?, ?);";
    protected static final String LIST_UPDATE = "UPDATE " + CURRENT_TABL + " SET " + COLUMN_ID_DB + "=?, " + COLUMN_NAME + "=?, " + COLUMN_DESCRIPTION + "=?, " + COLUMN_REMINDER + "=?, " + COLUMN_BACKGROUND + "=? WHERE " + COLUMN_ID_DB + "=?;";
